          ...
          <div class="row">
              ...
              <div class="row">
                <div class="col-lg-4 col-md-4">
                  <div class="card card-block card-stretch card-height">
                    <div class="card-body">
                      <div
                        class="d-flex align-items-center mb-4 card-total-sale"
                      >
                ...
                <div class="card-header d-flex justify-content-between">
                  ...
                  <div class="card-header-toolbar d-flex align-items-center">
                    <div class="dropdown">
                      ...
                      >
                        <a class="dropdown-item" href="index.html#">Year</a>
                        <a class="dropdown-item" href="index.html#">Month</a>
                        <a class="dropdown-item" href="index.html#">Week</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-lg-4">
              <div class="card-transparent card-block card-stretch mb-4">
                <div
                  class="card-header d-flex align-items-center justify-content-between p-0"
                >
                  <div class="header-title">
              ...
              <div class="card card-block card-stretch card-height">
                ...
                <div class="card-body pb-2">
                  <div class="d-flex flex-wrap align-items-center mt-2">
                    ...
                    <div
                      class="d-flex align-items-center ml-5 progress-order-right"
                    >
                      <div
