                    ...
                    >
                      ...
                      <tbody>
                          ...
                          <td>
                            ...
                            >
                              <a
                                ...
                                href="user-list.html#"
                                ><i class="ri-user-add-line mr-0"></i
                              ></a>
                              <a
                                class="btn btn-sm bg-primary"
                                data-toggle="tooltip"
                        ...
                        <tr>
                          ...
                          <td>Africa</td>
                          <td>
                            <span class="badge bg-success-light">Complite</span>
                          </td>
                          <td>Vehement Capital</td>
                          <td>2019/12/01</td>
                          <td>
                      ...
                      <nav aria-label="Page navigation example">
                        <ul class="pagination justify-content-end mb-0">
                          ...
                          <li class="page-item active">
                            <a class="page-link" href="user-list.html#">1</a>
                          </li>
                          <li class="page-item">
                            <a class="page-link" href="user-list.html#">2</a>
                          </li>
                          <li class="page-item">
                            <a class="page-link" href="user-list.html#">3</a>
                          </li>
                          <li class="page-item">
                            <a class="page-link" href="user-list.html#">Next</a>
                          </li>
                        </ul>
                      </nav>
                    </div>
